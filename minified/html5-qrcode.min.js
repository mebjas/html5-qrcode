...
function _instanceof(e,t){return null!=t&&"undefined"!=typeof Symbol&&t[Symbol.hasInstance]?!!t[Symbol.hasInstance](e):e instanceof t}function _classCallCheck(e,t){if(!_instanceof(e,t))throw new TypeError("Cannot call a class as a function")}function _defineProperties(e,t){for(var n=0;n<t.length;n++){var a=t[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}function _createClass(e,t,n){return t&&_defineProperties(e.prototype,t),n&&_defineProperties(e,n),e}function _defineProperty(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}var Html5Qrcode=function(){function e(t){_classCallCheck(this,e),this._elementId=t,this._foreverScanTimeout=null,this._localMediaStream=null,this._shouldScan=!0,this._url=window.URL||window.webkitURL||window.mozURL||window.msURL,this._userMedia=navigator.getUserMedia||navigator.webkitGetUserMedia||navigator.mozGetUserMedia||navigator.msGetUserMedia}return _createClass(e,[{key:"start",value:function(t,n,a,i){if(!t)throw"cameraId is required";if(!a||"function"!=typeof a)throw"qrCodeSuccessCallback is required and should be a function.";i||(i=console.log);var o=this,r=n||{};r.fps=r.fps?r.fps:e.SCAN_DEFAULT_FPS;var c=null!=r.qrbox,s=document.getElementById(this._elementId),l=s.clientWidth?s.clientWidth:e.DEFAULT_WIDTH,d=s.clientHeight?s.clientHeight:e.DEFAULT_HEIGHT;if(c){var h=r.qrbox;if(h<e.MIN_QR_BOX_SIZE)throw"minimum size of 'config.qrbox' is ".concat(e.MIN_QR_BOX_SIZE,"px.");if(h>l||h>d)throw"'config.qrbox' should not be greater than the width and height of the HTML element."}var u=c?this._getShadedRegionBounds(l,d,r.qrbox):{x:0,y:0,width:l,height:d},_=this._createVideoElement(l,d),m=this._createCanvasElement(u.width,u.height),f=m.getContext("2d");f.canvas.width=u.width,f.canvas.height=u.height,s.style.position="relative",s.append(_),s.append(m),c&&this._possiblyInsertShadingElement(s,d,u),this._element=s,this._videoElement=_,this._canvasElement=m,this._shouldScan=!0,qrcode.callback=a;var g=function(t){_.srcObject=t,_.play(),o._localMediaStream=t,function t(){if(o._shouldScan){if(o._localMediaStream){f.drawImage(_,u.x,u.y,u.width,u.height,0,0,u.width,u.height);try{qrcode.decode()}catch(e){i("QR code parse error, error = ".concat(e))}}o._foreverScanTimeout=setTimeout(t,e._getTimeoutFps(r.fps))}}()};return new Promise(function(e,n){if(navigator.mediaDevices&&navigator.mediaDevices.getUserMedia)navigator.mediaDevices.getUserMedia({audio:!1,video:{deviceId:{exact:t}}}).then(function(t){g(t),e()}).catch(function(e){n("Error getting userMedia, error = ".concat(e))});else if(navigator.getUserMedia){var a={video:{optional:[{sourceId:t}]}};navigator.getUserMedia(a,function(t){g(t),e()},function(e){n("Error getting userMedia, error = ".concat(e))})}else n("Web camera streaming not supported by the browser.")})}},{key:"stop",value:function(){this._shouldScan=!1,clearTimeout(this._foreverScanTimeout);var t=this;return new Promise(function(n,a){var i=t._localMediaStream.getVideoTracks().length,o=0,r=function(){t._localMediaStream=null,t._element.removeChild(t._videoElement),t._element.removeChild(t._canvasElement),function(){for(;t._element.getElementsByClassName(e.SHADED_REGION_CLASSNAME).length;){var n=t._element.getElementsByClassName(e.SHADED_REGION_CLASSNAME)[0];t._element.removeChild(n)}}(),n(!0)};t._localMediaStream.getVideoTracks().forEach(function(e){e.stop(),++o>=i&&r()})})}},{key:"_createCanvasElement",value:function(e,t){var n=e,a=t,i=document.createElement("canvas");return i.style.width="".concat(n,"px"),i.style.height="".concat(a,"px"),i.style.display="none",i.id="qr-canvas",i}},{key:"_createVideoElement",value:function(e,t){var n=document.createElement("video");return n.style.height="".concat(t,"px"),n.style.width="".concat(e,"px"),n}},{key:"_getShadedRegionBounds",value:function(e,t,n){if(n>e||n>t)throw"'config.qrbox' should not be greater than the width and height of the HTML element.";return{x:(e-n)/2,y:(t-n)/2,width:n,height:n}}},{key:"_possiblyInsertShadingElement",value:function(t,n,a){0==a.x&&0==a.y||(t.append(this._createShadedElement(n,a,e.SHADED_LEFT)),t.append(this._createShadedElement(n,a,e.SHADED_RIGHT)),t.append(this._createShadedElement(n,a,e.SHADED_TOP)),t.append(this._createShadedElement(n,a,e.SHADED_BOTTOM)))}},{key:"_createShadedElement",value:function(t,n,a){var i=document.createElement("div");switch(i.style.position="absolute",i.style.height="".concat(t,"px"),i.className=e.SHADED_REGION_CLASSNAME,i.id="".concat(e.SHADED_REGION_CLASSNAME,"_").concat(a),i.style.background="#0000007a",a){case e.SHADED_LEFT:i.style.top="0px",i.style.left="0px",i.style.width="".concat(n.x,"px"),i.style.height="".concat(t,"px");break;case e.SHADED_RIGHT:i.style.top="0px",i.style.right="0px",i.style.width="".concat(n.x,"px"),i.style.height="".concat(t,"px");break;case e.SHADED_TOP:i.style.top="0px",i.style.left="".concat(n.x,"px"),i.style.width="".concat(n.width,"px"),i.style.height="".concat(n.y,"px");break;case e.SHADED_BOTTOM:i.style.bottom="0px",i.style.left="".concat(n.x,"px"),i.style.width="".concat(n.width,"px"),i.style.height="".concat(n.y,"px");break;default:throw"Unsupported shadingPosition"}return i}}],[{key:"getCameras",value:function(){var e=this;return new Promise(function(t,n){if(navigator.mediaDevices&&navigator.mediaDevices.enumerateDevices&&navigator.mediaDevices.getUserMedia)e._log("navigator.mediaDevices used"),navigator.mediaDevices.getUserMedia({audio:!1,video:!0}).then(function(a){navigator.mediaDevices.enumerateDevices().then(function(n){for(var a=[],i=0;i<n.length;i++){var o=n[i];"videoinput"==o.kind&&a.push({id:o.deviceId,label:o.label})}e._log("".concat(a.length," results found")),t(a)}).catch(function(e){n("".concat(e.name," : ").concat(e.message))})}).catch(function(e){n("".concat(e.name," : ").concat(e.message))});else if(MediaStreamTrack&&MediaStreamTrack.getSources){e._log("MediaStreamTrack.getSources used");MediaStreamTrack.getSources(function(n){for(var a=[],i=0;i!==n.length;++i){var o=n[i];"video"===o.kind&&a.push({id:o.id,label:o.label})}e._log("".concat(a.length," results found")),t(a)})}else e._log("unable to query supported devices."),n("unable to query supported devices.")})}},{key:"_getTimeoutFps",value:function(e){return 1e3/e}},{key:"_log",value:function(t){e.VERBOSE&&console.log(t)}}]),e}();_defineProperty(Html5Qrcode,"DEFAULT_HEIGHT",300),_defineProperty(Html5Qrcode,"DEFAULT_HEIGHT_OFFSET",2),_defineProperty(Html5Qrcode,"DEFAULT_WIDTH",300),_defineProperty(Html5Qrcode,"DEFAULT_WIDTH_OFFSET",2),_defineProperty(Html5Qrcode,"SCAN_DEFAULT_FPS",2),_defineProperty(Html5Qrcode,"MIN_QR_BOX_SIZE",50),_defineProperty(Html5Qrcode,"SHADED_LEFT",1),_defineProperty(Html5Qrcode,"SHADED_RIGHT",2),_defineProperty(Html5Qrcode,"SHADED_TOP",3),_defineProperty(Html5Qrcode,"SHADED_BOTTOM",4),_defineProperty(Html5Qrcode,"SHADED_REGION_CLASSNAME","qr-shaded-region"),_defineProperty(Html5Qrcode,"VERBOSE",!1);